...
import {getMessagesForStreets, getStreetsTitlesOfGovernmentBuildings, getStreetsTitlesOfHouses} from './../05_MAP/map';
...
test('create greeting messages for streets',()=>{
    let messages = getMessagesForStreets(city.houses);
